...
| Model | Params | Voice Presets | Emotion Tags | Voice Description | Reference Audio |
|-------|--------|:---:|:---:|:---:|:---:|
| Maya1 | 3B | - | 17 | Yes | - |
| Kokoro-82M | 82M | 11 | - | - | - |
| Chatterbox | 500M | - | 5 | - | Yes |
| Orpheus-3B | 3B | 8 | 8 | - | - |
| Qwen3-TTS | 1.7B | - | - | Yes | - |
| Fish Speech 1.5 | 500M | - | - | - | Yes |
| CosyVoice 2 | 500M | - | 1 | Yes | Yes |
| XTTS v2 | 500M | - | - | - | Yes |
...
- SoX (`sudo apt install sox libsox-fmt-all`) — required by Qwen3-TTS
...
| [Orpheus-3B](https://huggingface.co/canopylabs/orpheus-tts-0.1-finetune-prod) | HuggingFace | Yes | ~6 GB. Uses vLLM backend |
